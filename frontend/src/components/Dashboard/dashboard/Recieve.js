                        ...
                        <div className="card-content grey-text">
                            <div className="card-title row grey lighten-3">
                                ...
                                <div className="col m10 left">
                                    ...
                                    <p className="green-text left-align">You Owe +${getPayment.totalAmt}</p>
                                </div>
                            </div>
                            <div className="list-content">
                                <ul className="collection ">
                                {
                                    getPayment.groups.map((group)=>{
                                        return (
                                            <li className="collection-item grey lighten-5 grey-text text-lighten-1" key={group.id}>You Owe {getPayment.name} +${group.amt} for "{group.group}"</li>
                                        )
                                    })
                                }
                                </ul>
